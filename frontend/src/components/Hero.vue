<template>
  <section id="profil"
	...
	<div class="md:w-1/2 mb-10 md:mb-0">
  	<h1 class="text-5xl font-bold text-gray-800 mb-4 animate-slide-in-left"
          style="animation-delay: 200ms;">
    	Halo, Saya <span class="text-blue-600">Mas Amba</span>
  	</h1>
  	<p class="text-xl text-gray-600 mb-8 animate-slide-in-left"
         style="animation-delay: 400ms;">
    	Siswa SMK yang bersemangat dalam pengembangan web dan teknologi. Kelas king.
  	</p>
  	<a href="#kontak"
